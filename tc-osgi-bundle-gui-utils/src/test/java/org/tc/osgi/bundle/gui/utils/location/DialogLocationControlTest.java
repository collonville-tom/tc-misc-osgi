...
public class DialogLocationControlTest {
    ...
    public void test() {
        ...
        Assert.assertEquals(GraphicsEnvironment.getLocalGraphicsEnvironment().getMaximumWindowBounds().height / 2, d.height);
        Assert.assertEquals(GraphicsEnvironment.getLocalGraphicsEnvironment().getMaximumWindowBounds().width / 2, d.width);

        d = control.quaterEnvironnementDimension();
        Assert.assertEquals(GraphicsEnvironment.getLocalGraphicsEnvironment().getMaximumWindowBounds().height / 4, d.height);
        Assert.assertEquals(GraphicsEnvironment.getLocalGraphicsEnvironment().getMaximumWindowBounds().width / 4, d.width);
    }
}
